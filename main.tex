...
\author{
    \IEEEauthorblockN{Christopher Ricky \\ Soehartono}
    ...
    \and
    \IEEEauthorblockN{Fritz Gradiyoga}
    \IEEEauthorblockA{\textit{Computer Science Department} \\
    \textit{School of Computer Science} \\
    \textit{Bina Nusantara University} \\
    Jakarta, Indonesia 11480 \\
    ...
    \and
    \IEEEauthorblockN{Jessica Nathania Wenardi}
    \IEEEauthorblockA{\textit{Computer Science Department} \\
    \textit{School of Computer Science} \\
    \textit{Bina Nusantara University} \\
    Jakarta, Indonesia 11480 \\
    ...
    % Trik untuk memaksa baris baru dan menempatkan penulis ke-4 di tengah
    \end{tabular}\hfil\\[1cm]\begin{tabular}[t]{c}
    
    \IEEEauthorblockN{Ir. Andry Chowanda, S.Kom, MM, Ph.D., \\ MBCS, CCP, CME, IPM, SMIEEE}
    \IEEEauthorblockA{\textit{Computer Science Department} \\
    \textit{School of Computer Science} \\
    \textit{Bina Nusantara University} \\
    Jakarta, Indonesia 11480 \\
